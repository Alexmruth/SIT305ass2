...
public class MyCustomAdapter extends BaseAdapter implements ListAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        TextView itemName = (TextView)view.findViewById(R.id.shopName);
        TextView itemPrice = (TextView)view.findViewById(R.id.shopPrice);
        Button buyBtn = (Button)view.findViewById(R.id.buyBtn);
        itemName.setText(list.get(position));
        itemPrice.setText(list.get(position));
